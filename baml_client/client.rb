...
module Baml
  ...
  class BamlClient
    ...
    sig {
      ...
      ).returns(T::Array[Baml::Types::MealIdea])
    }
    def SuggestMeals(
        *varargs,
  ...
  class BamlStreamClient
    ...
    sig {
      params(
        ...
        profile: Baml::Types::UserProfile,flow_type: String,user_input: String,
        baml_options: T::Hash[Symbol, T.any(Baml::TypeBuilder, Baml::ClientRegistry, T.any(Baml::Collector, T::Array[Baml::Collector]), T::Hash[Symbol, String])]
      ).returns(Baml::BamlStream[T::Array[Baml::Types::MealIdea]])
    }
    def SuggestMeals(
        *varargs,
        profile:,flow_type:,user_input:,
      ...
      Baml::BamlStream[T::Array[T.nilable(Baml::PartialTypes::MealIdea)], T::Array[Baml::Types::MealIdea]].new(
        ffi_stream: raw,
        ctx_manager: @ctx_manager
      )
    end
